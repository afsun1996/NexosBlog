package top.afsun1996.nexos.util;
...
import top.afsun1996.nexos.constant.ALIOSS;
...
public class AliOSSUtils {
    ...
    public static  OSSClient getOSSClient(){
        return new OSSClient(ALIOSS.ALI_OSS_ENDPOINT,ALIOSS.ALI_OSS_ACCESSKEYID, ALIOSS.ALI_OSS_ACCESSKEYSECRET);
    }
    ...
    public static String getUrl(OSSClient ossClient, String key) {
        ...
        // 生成URL
        URL url = ossClient.generatePresignedUrl(ALIOSS.BACKET_NAME, key, expiration);
        if (url != null) {
            return url.toString();
        }
        return null;
